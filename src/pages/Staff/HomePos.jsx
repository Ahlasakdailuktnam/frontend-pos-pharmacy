...
const HomePos = () => {
  ...
  const handleCheckout = () => {
    ...
    // Prepare cart items to pass to checkout
    ...
    // Navigate to appropriate checkout page based on payment method
    if (paymentMethod === "cash") {
      navigate("/staff/checkPay", { 
        state: { 
          total, 
          subtotal, 
          cart: cartItems,
